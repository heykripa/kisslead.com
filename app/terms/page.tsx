  ...
  return (
    <PolicyPage title="Terms & Conditions">
      ...
      <p className="text-justify mb-4">
        ...
        regulations, privacy policy and Terms of Use for access or usage of domain name https://kisslead.com 
        ('Website'), including the related mobile site and mobile application (hereinafter referred to 
        as 'Platform').
      </p>
      <p className="text-justify mb-4">
        The Platform is owned by Kisslead Technologies, a company incorporated under the Companies Act, 1956 
        with its registered office at 89, NG Narayanaswamy Street, New Siddhapudur, Coimbatore - 641044 
      ...
      <ol className="list-decimal pl-6 space-y-4 text-justify">
        ...
        <li>
          ...
          jurisdiction of the courts in Coimbatore, India.
        </li>
        <li>
