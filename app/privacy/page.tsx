...
export default function PrivacyPage() {
  return (
    <PolicyPage title="Privacy Policy">
      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Introduction</h2>
      <p className="text-justify mb-4">
        This Privacy Policy describes how Kisslead Technologies and its affiliates (collectively "we, our, us") 
        collect, use, share, protect or otherwise process your information/ personal data through our website 
        https://kisslead.com (hereinafter referred to as Platform). Please note that you may be able to browse 
      ...
      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Collection</h2>
      <p className="text-justify mb-4">
      ...
      <ul className="list-disc pl-6 space-y-2 mb-4 text-justify">
        <li>Personal data / information provided to us during sign-up/registering or using our Platform such as name, date of birth, address, telephone/mobile number, email ID and/or any such information shared as proof of identity or address.</li>
        <li>Sensitive personal data collected with your consent, such as your bank account or credit or debit card or other payment instrument information or biometric information such as your facial features or physiological information (in order to enable use of certain features when opted for, available on the Platform) etc all of the above being in accordance with applicable law(s).</li>
      </ul>
      <p className="text-justify mb-4">
        You always have the option to not provide information, by choosing not to use a particular service or feature on the Platform. We may 
        ...
        any information. If you receive an email, a call from a person/association claiming to be Kisslead Technologies 
      ...
      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Usage</h2>
      <p className="text-justify mb-4">
      ...
      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Sharing</h2>
      <p className="text-justify mb-4">
      ...
      <ul className="list-disc pl-6 space-y-2 mb-4 text-justify">
        ...
        <li>Third party service providers including logistics partners, prepaid payment instrument issuers, third-party reward programs and other payment opted by you.</li>
      </ul>
      <p className="text-justify mb-4">
        These disclosure may be required for us to provide you access to our services and 
      ...
      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Security Precautions</h2>
      <p className="text-justify mb-4">
      ...
      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Data Deletion and Retention</h2>
      <p className="text-justify mb-4">
      ...
      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Your Rights</h2>
      <p className="text-justify mb-4">
        You may access, rectify, and update your personal data directly through the functionalities 
        provided on the Platform.
      </p>

      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Consent</h2>
      <p className="text-justify mb-4">
      ...
      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Changes to this Privacy Policy</h2>
      <p className="text-justify mb-4">
      ...
      <h2 className="text-2xl md:text-3xl font-medium mt-12 mb-6">Grievance Officer</h2>
      <p className="text-justify mb-4">
        <strong>Name:</strong> Durkesh<br />
        <strong>Designation:</strong> CEO<br />
        <strong>Company:</strong> Kisslead Technologies<br />
        <strong>Address:</strong> 89, NG Narayanaswamy Street, New Siddhapudur, Coimbatore - 641044<br />
        <strong>Email:</strong> hello@kisslead.com<br />
        <strong>Phone Time:</strong> Monday - Friday (9:00 - 18:00)
      </p>
    </PolicyPage>
  )
}
